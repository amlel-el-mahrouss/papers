...
\begin{corollary}
	...
	\end{align*}
	Adding a tensor $\mathcal{T}_2 \in \mathbb{R}.$:
	\begin{align*}
		F(x, k) + \mathcal{T}_2 &= \mathcal{M}(x, k)^{2} + \mathcal{M}(x, k) + \mathcal{T}_2.
	\end{align*}
	A more complete definition of $\mathcal{T}_2$ would then be:
	\begin{align*}
		\mathcal{T}_2 &= \mathcal{M}(x, k)^{2} + \mathcal{M}(x, k)^{1} + \mathcal{T}_2 - F(x, k), \quad \forall x, k \in \mathbb{R}.
	\end{align*}
\end{corollary}
