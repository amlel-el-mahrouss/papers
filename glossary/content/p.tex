...
\lettrine[lines=2, lhang=0.1, loversize=0.2]{T}he glossary's purpose is to be provide a reference for definitions, theorems, and equations for the purpose of being reusable.\\
...
\begin{definition}
	...
	\end{align*}
	Admits a transcendental number.
\end{definition}
