...
\end{theorem}
\begin{proof}
Per Theorem 1.1. Let the following in $\mathbb{R}$ by induction.:\\(i) By the property of $\pi^{1/12}$ being transcendental, by the previously stated inequality in $\mathbb{R}.$:
\begin{align*}
