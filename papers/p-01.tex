...
\section{Abstract}
Property 01 lays out the weight of a variable $S$ over a frequency $F$ that may be equal to the division of the value between the highest signal and lowest signal of $S$.
