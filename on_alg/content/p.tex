...
\begin{theorem}
	There exists for $p, \operatorname{L}, a, q, k \in \mathbb{R}.$:
	\begin{equation}
		\lim_{p \to \operatorname{L}} (\frac{f(a, qk)}{k} + (\pi^{1/12} - \frac{\zeta(3)}{\pi}))^p.
	\end{equation}
	Solutions of $\lim_{p \to \operatorname{L}} (\frac{f(a, qk)}{k} + (\pi^{1/12} - \frac{\zeta(3)}{\pi}))^p,$ in  $\operatorname{L} \in \{2k : k \in \mathbb{Z}\}.$
\end{theorem}
\begin{remark}
	There may exists a infinite set of solutions in $\operatorname{L} \in \{2k : k \in \mathbb{Z}\}$ in parity.
\end{remark}
\begin{remark}
